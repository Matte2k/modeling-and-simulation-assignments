...
% \begin{figure}[htb]
%     \centering
%     \includegraphics*[width=0.8\textwidth, keepaspectratio]{ex1_simscapeCase1.eps}
%     \caption[]{\label{fig:simscapeCase1} TBD}
% \end{figure}
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics*[width=0.8\textwidth, keepaspectratio]{ex1_simscapeCase2.eps}
%     \caption[]{\label{fig:simscapeCase2} TBD}
% \end{figure}

Using the same method and solver settings as before the nodes temperature over time are obtained and reported in %\cred{fig:ex1_}.
