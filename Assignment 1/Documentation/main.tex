...
\begin{minipage}{0.50\textwidth}
    ...
    \begin{center}
        ...
        \captionof{table}{\label{tab:ex4_feval} Solutions of root finding problem}
        \begin{tabular}{lccc}               % ##### ricontrolla risultati con quelli ottenuti dal fisso
            \toprule
            \toprule
            $Toll$ & RK1& RK2& RK4\\ 
            \midrule                    
...
\begin{minipage}{0.45\textwidth}
    ...
    \begin{center}
        ...
        \captionof{figure}{\label{fig:ex4_feval} Methods function evaluation vs tollerance}
    \end{center}
\end{minipage}
